        ...
        <div class="row match-height">
            <div class="col-xl-8 col-md-7 col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-2">
                            <input type="text" class="form-control" wire:model.defer="title" placeholder="Judul Artikel">
                        </div>
            ...
            <div class="col-xl-4 col-md-5 col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div wire:ignore>
                            <input class="form-control" data-pharaonic="tagify" data-component-id="{{ $this->id }}" wire:model.defer="tags" data-direct>
                        </div>
                    </div>
                </div>
            </div>
