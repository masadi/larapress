                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Satminkal</th>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm dropstart">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        <li><a class="dropdown-item" wire:click="getID('detil', '{{$item->ptk_id}}')">Detil</a></li>
                                        <li><a class="dropdown-item" wire:click="getID('edit', '{{$item->ptk_id}}')">Edit</a></li>
                                        <li><a class="dropdown-item" wire:click="getID('jadwal', '{{$item->ptk_id}}')">Jadwal</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
