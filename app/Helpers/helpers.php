...
class Helper
{
    public static function backEndClasses()
    {
        // default data array
        $DefaultData = [
        ...
        $data = array_merge($DefaultData, config('custom.backend'));
    ...
    public static function frontEndClasses()
    {
        // default data array
        $DefaultData = [
            'mainLayoutType' => 'vertical',
        ...
        // if any key missing of array from custom.php file it will be merge and set a default value from dataDefault array and store in data variable
        $data = array_merge($DefaultData, config('custom.frontend'));
